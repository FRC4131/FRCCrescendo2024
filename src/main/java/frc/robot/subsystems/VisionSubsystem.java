...
public class VisionSubsystem extends SubsystemBase {
  ...
  public Optional<EstimatedRobotPose> aprilTagUpdate()
  {
    ...
    {
      rawBotPose = NetworkTableInstance.getDefault().getTable("limelight-front").getEntry("botpose_wpiblue").getDoubleArray(new double[7]); //gets blue pose (one coordinate system)
